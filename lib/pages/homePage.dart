...
import 'package:flutter_tiktok/pages/postPage.dart';
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  TikTokPageTag tabBarType = TikTokPageTag.follow;
  ...
  Widget build(BuildContext context) {
    ...
    switch (tabBarType) {
      ...
      case TikTokPageTag.follow:
        currentPage = FollowPage();  // 这里使用新的 FollowPage
        break;
    ...
    return TikTokScaffold(
      ...
      leftPage: searchPage,
      rightPage: userPage,
      enableGesture: tabBarType == TikTokPageTag.follow,
